...
/*        $('.icon-library').on('click', function(){
        ...
        $('.icon-toc').on('click', function(){
            // we need to close the book here - how to do it??
            //var value = $('#reading-area').detach();
        ...
        $('.icon-enlarge').on('click', function(){
            var dialog_width = $("#epubdialog").dialog("option","width");
            $("#epubdialog").dialog({width: dialog_width*1.1});
